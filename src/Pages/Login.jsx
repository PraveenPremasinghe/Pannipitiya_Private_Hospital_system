...
<div>
 ...
 <div className="row">
    ...
    <div className="logologin">
      ...
      <h5 class="signup">Sign Up to your account</h5>
      ...
      <Form.Group className="mb-3 mt-3 " controlId="exampleForm.ControlInput1">
        ...
        <Form.Control type="Passowrd" placeholder="Re-Passowrd" />
      </Form.Group>
     
     <button className="loginbuttn">Sign Up</button>
    </Form>
      </div>
   

   <div className="account">If you have an Account?  <Link to="/Signin"> Sign In </Link></div> 
